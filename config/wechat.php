...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID_FWH', 'your-app-id'),         // AppID
    'secret'  => env('WECHAT_SECRET_FWH', 'your-app-secret'),     // AppSecret
     ...
     */
     'payment' => [
         ...
         'notify_url'         => env('WECHAT_PAYMENT_NOTIFY_URL', 'notify-url'),
